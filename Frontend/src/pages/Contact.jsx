    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 overflow-y-scroll scrollbar-hide">
      ...
      >
        <div
          ...
          // className="relative left-1/2 -z-10 aspect-[1024/768] w-[35.120rem] max-w-none -translate-x-1/2 rotate-[25deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1870rem]"
        />
      </div>
